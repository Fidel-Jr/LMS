...
namespace LmsProject.Migrations
{
    ...
    [Migration("20250905050851_AddModuleMaterialModel")]
    partial class AddModuleMaterialModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LmsProject.Models.ModuleMaterial", b =>
                {
                    b.HasOne("LmsProject.Models.Course", null)
                        ...
                        .HasForeignKey("CourseId")
                        .HasConstraintName("fk_module_materials_courses_course_id");
                    ...
                    b.HasOne("LmsProject.Models.Module", "Module")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_materials_modules_material_id");
                    ...
                    b.HasOne("LmsProject.Models.Material", "Material")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_module_materials_materials_material_id1");
